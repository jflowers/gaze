...
// reducedGodocWeight is the signal weight when a contractual keyword
// is found but the effect type does not match the keyword's impliesFor
// list. This provides a positive signal for well-documented functions
// without inflating scores as much as a direct type match.
